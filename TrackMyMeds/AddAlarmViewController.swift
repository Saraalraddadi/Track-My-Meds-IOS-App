...
class AddAlarmViewController: UIViewController, UITextFieldDelegate {
    ...
    func scheduleNotification(at date: Date) {
        ...
        if let medName = medNameis, let medTime = AlarmTime
        {
...
//        request.content.setValue("morning", forKey: "time")
    ...
    func addTapped() {
        if medNameis != nil
        {
            ...
            alarm?.alarmTLabel = AlarmTime
            alarm?.medicineName = medNameis
            ...
            else
            {
                ...
                print("$$$$$$$$$$$$$$$ ALarm not added successfully $$$$$$$$$$$$$")
    ...
    func showDatePicker(textField: UITextField) {
        let datePicker = ActionSheetDatePicker(title: "Select Time & Date", datePickerMode: UIDatePickerMode.dateAndTime, selectedDate: NSDate() as Date!, doneBlock: {
            ...
            fullFormatter.dateFormat = "yyyy-MM-dd hh:mm a"
            
            //let dateString = fullFormatter.string(from: value as! Date)
            //print("selected date is - - - - - - >>>>>>>> \(dateString)")
            let fullDateString = fullFormatter.string(from: value as! Date)
            ...
            self.alarm?.alarmDate = dateString
            //print(value as! Date+86400)
            
            self.timeField.text = fullDateString
            self.AlarmTime = fullDateString
